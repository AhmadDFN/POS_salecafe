        ...
        <div class="row">
            <div class="dt_foto col-md-3">
                <div class="card">
                    <div class="card-body">
                        <img id="avatar"
                            src="{{ @$rsMember->foto != '' ? $rsMember->foto : asset('images/no-images.jpg') }}"
                            alt="">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('kd_member') is-invalid  @enderror"
                                id="kd_member" name="kd_member" placeholder="Kode Member"
                                value="{{ old('kd_member') ? old('kd_member') : @$rsMember->kd_member }}">
                            @error('kd_member')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nm_member') is-invalid  @enderror"
                                id="nm_member" name="nm_member" placeholder="Nama Member"
                                value="{{ old('nm_member') ? old('nm_member') : @$rsMember->nm_member }}">
                            @error('nm_member')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control  @error('alamat') is-invalid  @enderror" id="alamat" name="alamat"
                                placeholder="Alamat">{{ old('alamat') ? old('alamat') : @$rsMember->alamat }}</textarea>
                            @error('alamat')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('kota') is-invalid  @enderror" id="kota"
                                ...
                                value="{{ old('kota') ? old('kota') : @$rsMember->kota }}">
                            @error('kota')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('telp') is-invalid  @enderror" id="telp"
                                ...
                                value="{{ old('telp') ? old('telp') : @$rsMember->telp }}">
                            @error('telp')
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select rounded-0 @error('jk') is-invalid  @enderror" id="jk"
                                name="jk">
