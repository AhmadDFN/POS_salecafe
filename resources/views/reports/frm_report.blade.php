...
<div class="row">
    <div class="col-lg-6">
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="{{ url("reports/cetak/transaksi/tanggal")}}" method="post"  target= "blank">
                    @csrf
    ...
    <div class="col-lg-6">
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="{{ url("reports/cetak/transaksi/member")}}" method="post"  target= "blank">
                    @csrf
                    <div class="form-group">
    ...
    <div class="col-lg-6">
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="{{ url("reports/cetak/transaksi")}}" method="get"  target= "blank">
                    @csrf
                    <div class="form-group">
                        <input  class="btn btn-primary" type="submit" value="CETAK">
                    </div>
